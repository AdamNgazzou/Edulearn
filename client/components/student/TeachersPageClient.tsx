...
export default function TeachersPageClient({ teachers }: { teachers: any }) {
  return (
                      ...
                      <ul className="space-y-1">
                        {teacher.courses.map((course : any) => (
                          <li key={course.id} className="text-sm">
                            <Link href={`/student/course/${course.id}`} className="flex items-center gap-1 text-primary hover:underline">
